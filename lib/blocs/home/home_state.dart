...
class HomeState with _$HomeState {
  ...
  const factory HomeState.changeSelectedCategoryIndex(final int index) =
      ChangeSelectedCategoryIndexState;
  ...
  const factory HomeState.getCarsByBrandSuccess() = GetCarsByBrandSuccessState;
